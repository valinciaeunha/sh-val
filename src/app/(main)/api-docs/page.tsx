...
export default function ApiDocsPage() {
                            ...
                            <div className="space-y-16 animate-in fade-in duration-500">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-offgray-400 leading-relaxed max-w-3xl mb-8">
                                        Validate a license key from your Roblox executor or any client. This endpoint checks the key status, expiry, and optionally binds the client&apos;s hardware ID (HWID) for device locking. If the key is valid and unused, it will automatically be activated. No API key or authentication is required for this endpoint.
                                    </p>
  ...
  // Required string: The UUID of the script this key belongs to
...
// Key does not belong to this script
{
  "success": false,
  "valid": false,
...
local SCRIPT_ID = "your-script-uuid-here"
...
local response = request({
    ...
    Body = HttpService:JSONEncode({
        key = "SH-id581889ce6357438e82daf430c5c",
        scriptId = SCRIPT_ID,
        hwid = gethwid()  -- optional: executor HWID function
    })
})
